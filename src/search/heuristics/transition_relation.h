...
class TransitionRelation {
    std::shared_ptr<SymVariables> sV; // To call basic BDD creation methods
...
public:
    ...
    TransitionRelation(std::shared_ptr<SymVariables> sVars, OperatorID op_id,
    ...
    std::shared_ptr<SymVariables> get_sym_vars() const {return sV;}
};
}
#endif
